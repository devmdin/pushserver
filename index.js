...
// নিরাপত্তার জন্য: env variable (SERVICE_ACCOUNT_JSON) থাকলে সেটা ব্যবহার করো,
// না থাকলে local ফাইল থেকে load করো (local dev-এর জন্য)
...
// POST /register-token  { token, appId, userAgent? }
...
// ── Get tokens by appId ──
// GET /tokens?appId=com.myapp.xyz
...
// ── Send to one token ──
// POST /send-notification  { token, title, body, imageUrl }
...
// POST /send-all  { appId, title, body, imageUrl }
